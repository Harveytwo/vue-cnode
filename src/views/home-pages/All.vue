<template>
  <div class="all">
    ...
    <div class="topicLists">
      ...
      <div v-for="item in topics" class="item">
        <a href="" class="author">
        ...
        <div class="titleWrap">
          ...
          <span v-if="item.tab == 'ask' && !item.top && !item.good " class="nomalTab">问答</span>
          <span v-if=" item.tab == 'share' && !item.top && !item.good " class="nomalTab">分享</span>
          <span v-if="item.tab == 'job' && !item.top && !item.good " class="nomalTab">招聘</span>
